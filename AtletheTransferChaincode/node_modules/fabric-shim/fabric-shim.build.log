...
> fabric-shim@2.1.4 test /home/vsts/work/1/s/libraries/fabric-shim
> nyc mocha --recursive 'test/unit/**/*.js' --reporter azure-mocha-reporter


> fabric-shim@2.1.4 lint /home/vsts/work/1/s/libraries/fabric-shim
> eslint ./lib
...
2020-06-22T15:00:53.685Z info [c-api:lib/chaincode.js]                            Registering with peer localhost:7051 as chaincode "mycc"  
      ✓ should start when passed init and invoke
2020-06-22T15:00:53.692Z info [c-api:lib/chaincode.js]                            Registering with peer localhost:7051 as chaincode "mycc"  
...
2020-06-22T15:00:53.720Z info [c-api:lib/chaincode.js]                            Registering with peer localhost:7051 as chaincode "mycc"  
        ✓ should call handler.chat() with the correct object and output a message
2020-06-22T15:00:53.732Z info [c-api:lib/chaincode.js]                            Registering with peer localhost:7051 as chaincode "mycc"  
        ✓ should load the opts certificate attributes as JSON strings with the correct properties
    parsePeerUrlFcn
2020-06-22T15:00:53.736Z error [c-api:lib/chaincode.js]                           The "peer.address" program argument must be set to a legitimate value of <host>:<port>  
      ✓ should throw an error if peer.address not set
2020-06-22T15:00:53.739Z error [c-api:lib/chaincode.js]                           The "peer.address" program argument can not be set to an "http(s)" url, use grpc(s) or omit the protocol  
...
2020-06-22T15:00:53.786Z info [c-api:fabric-shim/cli]                             
Command succeeded
  
      ✓ should handle rejected promise  correctly
2020-06-22T15:00:53.789Z info [c-api:fabric-shim/cli]                             undefined
Command failed
...
(node:3149) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 uncaughtException listeners added to [process]. Use emitter.setMaxListeners() to increase limit
    ...
    #getMetadata
2020-06-22T15:00:54.459Z info [c-api:contracts-spi/bootstrap.js]                  Metadata file has been located  
      ✓ should handle when there are files available
2020-06-22T15:00:54.511Z info [c-api:contracts-spi/bootstrap.js]                  No metadata file supplied in contract, introspection will generate all the data  
...
schema $id ignored http://json-schema.org/draft-07/schema#
schema $id ignored http://json-schema.org/draft-07/schema#
2020-06-22T15:00:54.596Z info [c-api:contracts-spi/bootstrap.js]                  Metadata validated against schema correctly  
...
schema $id ignored https://example.com/person.schema.json
schema $id ignored https://example.com/person.schema.json
2020-06-22T15:00:54.676Z info [c-api:contracts-spi/bootstrap.js]                  Metadata validated against schema correctly  
...
2020-06-22T15:00:54.682Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle a single class being passed as a contract
2020-06-22T15:00:54.685Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle a case where the metadata is incompatible with code
    #_compileSchemas
2020-06-22T15:00:54.687Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle no complex objects being available
2020-06-22T15:00:54.689Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle complex objects being available
    #_resolveContractImplementations
2020-06-22T15:00:54.692Z info [c-api:./lib/contract.js]                           Creating new Contract "alpha" 
2020-06-22T15:00:54.693Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle a single class being passed as a contract
      ✓ should handle a single class being passed that is not valid
2020-06-22T15:00:54.696Z info [c-api:./lib/contract.js]                           Creating new Contract "beta" 
2020-06-22T15:00:54.696Z info [c-api:./lib/contract.js]                           Creating new Contract "alpha" 
2020-06-22T15:00:54.697Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle a two classes being passed as a contract
2020-06-22T15:00:54.699Z info [c-api:./lib/contract.js]                           Creating new Contract "beta" 
2020-06-22T15:00:54.699Z info [c-api:./lib/contract.js]                           Creating new Contract "alpha" 
2020-06-22T15:00:54.699Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle the default tag being used
    #init
2020-06-22T15:00:54.702Z info [c-api:./lib/contract.js]                           Creating new Contract "alpha" 
2020-06-22T15:00:54.702Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
<Buffer 44 65 66 61 75 6c 74 20 69 6e 69 74 69 61 74 6f 72 20 73 75 63 63 65 73 73 66 75 6c 2e>
      ✓ should handle no args
2020-06-22T15:00:54.715Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle a single class being passed as a contract
2020-06-22T15:00:54.717Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle a single class being passed as a contract
    #invoke
2020-06-22T15:00:54.720Z info [c-api:./lib/contract.js]                           Creating new Contract "alpha" 
2020-06-22T15:00:54.720Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle no args
2020-06-22T15:00:54.724Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle a single class being passed as a contract
2020-06-22T15:00:54.726Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
2020-06-22T15:00:54.726Z info [c-api:./lib/contract.js]                           Creating new Contract "logging" 
2020-06-22T15:00:54.731Z info [c-api:logging]                                     info  
    ...
    #invokeFunctionality
2020-06-22T15:00:54.739Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
2020-06-22T15:00:54.740Z error [c-api:contracts-spi/chaincodefromcontract.js]     a logging prefix Error: Contract name is not known: name  
...
2020-06-22T15:00:54.747Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
undefined
      ✓ should handle valid contract name, but missing function
2020-06-22T15:00:54.751Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
error
...
2020-06-22T15:00:54.755Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
undefined
      ✓ should handle valid contract name, with valid function
2020-06-22T15:00:54.760Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
undefined
...
2020-06-22T15:00:54.770Z info [c-api:./lib/contract.js]                           Creating new Contract "alpha" 
2020-06-22T15:00:54.770Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should be able to handle no annotations suppled
2020-06-22T15:00:54.772Z info [c-api:./lib/contract.js]                           Creating new Contract "alpha" 
2020-06-22T15:00:54.772Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should be able to handle no annotations suppled
    #_processContractTransactions
2020-06-22T15:00:54.774Z info [c-api:./lib/contract.js]                           Creating new Contract "alpha" 
2020-06-22T15:00:54.774Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle no transaction annotations used, ignoring functions that match in name to ignore array
2020-06-22T15:00:54.776Z info [c-api:./lib/contract.js]                           Creating new Contract "alpha" 
2020-06-22T15:00:54.777Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle no transaction annotations used, ignoring functions that start with _
2020-06-22T15:00:54.779Z info [c-api:./lib/contract.js]                           Creating new Contract "alpha" 
2020-06-22T15:00:54.779Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should not add submitTx to the system contract functions
2020-06-22T15:00:54.781Z info [c-api:./lib/contract.js]                           Creating new Contract "alpha" 
2020-06-22T15:00:54.781Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should handle transaction annotations being used
2020-06-22T15:00:54.783Z info [c-api:./lib/contract.js]                           Creating new Contract "alpha" 
2020-06-22T15:00:54.783Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
...
2020-06-22T15:00:54.828Z error [c-api:contracts-spi/datamarshall.js]              undefined Expected 1 parameters, but 0 have been supplied  
  ...
  SystemContract
    #constructor
2020-06-22T15:00:54.843Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
      ✓ should create correctly
    #GetMetadata
2020-06-22T15:00:54.844Z info [c-api:./lib/contract.js]                           Creating new Contract "org.hyperledger.fabric" 
...
2020-06-22T15:00:54.857Z error [c-api:lib/handler.js]                             Failed to find a message for transaction context id theChannelIDaTX  
    ...
    ChaincodeMessageHandler
      chat
        ...
        stream.on.data
2020-06-22T15:00:54.941Z error [c-api:lib/handler.js]                             Chaincode is in "created" state, can only process messages of type "registered", but received "NOT REGISTERED"  
          ✓ should throw error when in state created and MSG_TYPE not REGISTERED
2020-06-22T15:00:54.968Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2020-06-22T15:00:54.969Z error [c-api:lib/handler.js]                             Chaincode is in "ready" state, can only process messages of type "established", but received "NOT REGISTERED"  
          ✓ should throw error when in state established and MSG_TYPE not READY
2020-06-22T15:00:54.989Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2020-06-22T15:00:54.989Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should do nothing when in state ready and MSG_TYPE equals REGISTERED
2020-06-22T15:00:55.011Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2020-06-22T15:00:55.011Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should do nothing when in state ready and MSG_TYPE equals READY
2020-06-22T15:00:55.033Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2020-06-22T15:00:55.033Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should call handleMsgResponse when in state ready and MSG_TYPE equals RESPONSE
2020-06-22T15:00:55.052Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2020-06-22T15:00:55.052Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should call handleMsgResponse when in state ready and MSG_TYPE equals ERROR
2020-06-22T15:00:55.069Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2020-06-22T15:00:55.069Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should call handleInit when in state ready and MSG_TYPE equals INIT
2020-06-22T15:00:55.088Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2020-06-22T15:00:55.088Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
          ✓ should call handleTransaction when in state ready and MSG_TYPE equals TRANSACTION
2020-06-22T15:00:55.103Z info [c-api:lib/handler.js]                              Successfully registered with peer node. State transferred to "established"  
2020-06-22T15:00:55.103Z info [c-api:lib/handler.js]                              Successfully established communication with peer node. State transferred to "ready"  
2020-06-22T15:00:55.103Z error [c-api:lib/handler.js]                             Received unknown message from the peer. Exiting.  
          ✓ should end the process with value 1
        stream.on.end
          ✓ should cancel the stream
        stream.on.error
2020-06-22T15:00:55.144Z error [c-api:lib/handler.js]                             Chat stream with peer - on error: %j {} 
          ✓ should end the stream
2020-06-22T15:00:55.158Z error [c-api:lib/handler.js]                             Chat stream with peer - on error: %j "Error\n    at Context.<anonymous> (/home/vsts/work/1/s/libraries/fabric-shim/test/unit/handler.js:831:35)\n    at callFn (/home/vsts/work/1/s/common/temp/node_modules/.pnpm/registry.npmjs.org/mocha/6.2.2/node_modules/mocha/lib/runnable.js:387:21)\n    at Test.Runnable.run (/home/vsts/work/1/s/common/temp/node_modules/.pnpm/registry.npmjs.org/mocha/6.2.2/node_modules/mocha/lib/runnable.js:379:7)\n    at Runner.runTest (/home/vsts/work/1/s/common/temp/node_modules/.pnpm/registry.npmjs.org/mocha/6.2.2/node_modules/mocha/lib/runner.js:535:10)\n    at /home/vsts/work/1/s/common/temp/node_modules/.pnpm/registry.npmjs.org/mocha/6.2.2/node_modules/mocha/lib/runner.js:653:12\n    at next (/home/vsts/work/1/s/common/temp/node_modules/.pnpm/registry.npmjs.org/mocha/6.2.2/node_modules/mocha/lib/runner.js:447:14)\n    at /home/vsts/work/1/s/common/temp/node_modules/.pnpm/registry.npmjs.org/mocha/6.2.2/node_modules/mocha/lib/runner.js:457:7\n    at next (/home/vsts/work/1/s/common/temp/node_modules/.pnpm/registry.npmjs.org/mocha/6.2.2/node_modules/mocha/lib/runner.js:362:14)\n    at Immediate._onImmediate (/home/vsts/work/1/s/common/temp/node_modules/.pnpm/registry.npmjs.org/mocha/6.2.2/node_modules/mocha/lib/runner.js:425:5)\n    at processImmediate (internal/timers.js:439:21)" 
    ...
    handleMessage
      Error
2020-06-22T15:00:55.555Z error [c-api:lib/handler.js]                             %s Incorrect payload format. Sending ERROR message back to peer "[theChannelID-aTX]" 
        ✓ should handle an error decoding the payload
2020-06-22T15:00:55.557Z error [c-api:lib/handler.js]                             Failed to construct a chaincode stub instance from the INIT message: an error
    at Object.fake.exceptionCreator (/home/vsts/work/1/s/common/temp/node_modules/.pnpm/registry.npmjs.org/sinon/7.5.0/node_modules/sinon/lib/sinon/default-behaviors.js:18:32)
    at Object.invoke (/home/vsts/work/1/s/common/temp/node_modules/.pnpm/registry.npmjs.org/sinon/7.5.0/node_modules/sinon/lib/sinon/behavior.js:151:35)
...
2020-06-22T15:00:55.558Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Init() has not called success or error.  
2020-06-22T15:00:55.558Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Init() returned error response [[theChannelID-aTX] Calling chaincode Init() has not called success or error.]. Sending ERROR message back to peer  
        ✓ should handle chaincode.Init returning nothing
2020-06-22T15:00:55.560Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Invoke() has not called success or error.  
2020-06-22T15:00:55.560Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Invoke() returned error response [[theChannelID-aTX] Calling chaincode Invoke() has not called success or error.]. Sending ERROR message back to peer  
        ✓ should handle chaincode.Invoke returning nothing
2020-06-22T15:00:55.561Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Init() has not called success or error.  
2020-06-22T15:00:55.561Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Init() returned error response [[theChannelID-aTX] Calling chaincode Init() has not called success or error.]. Sending ERROR message back to peer  
        ✓ should handle chaincode.Init returning no status
2020-06-22T15:00:55.563Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Invoke() has not called success or error.  
2020-06-22T15:00:55.563Z error [c-api:lib/handler.js]                             [theChannelID-aTX] Calling chaincode Invoke() returned error response [[theChannelID-aTX] Calling chaincode Invoke() has not called success or error.]. Sending ERROR message back to peer  
        ✓ should handle chaincode.Invoke returning no status
      Complete
2020-06-22T15:00:55.565Z info [c-api:lib/handler.js]                              [theChannelID-aTX] Calling chaincode Init() succeeded. Sending COMPLETED message back to peer  
        ✓ should write a COMPLETE message when successful init
2020-06-22T15:00:55.566Z info [c-api:lib/handler.js]                              [theChannelID-aTX] Calling chaincode Invoke() succeeded. Sending COMPLETED message back to peer  
...
2020-06-22T15:00:55.626Z error [c-api:lib/iterators.js]                           unexpected error received getting next value: %s "some error" 
  ...
  Logger
    ✓ coverage
2020-06-22T15:00:55.636Z error [c-api:_]                                          Unhandled Rejection reason __PERMITTED__ promise Promise { <rejected> '__PERMITTED__' }  
    getLogger
...
2020-06-22T15:00:55.657Z error [c-api:lib/server.js]                              ChaincodeServer failed to bind to 0.0.0.0:9999  
      ✓ should throw if bindAsync fails
    connect()
      ✓ should call connect
2020-06-22T15:00:55.660Z warn [c-api:lib/server.js]                               connection from peer failed: Error: Some error from chat  
...
=============================== Coverage summary ===============================
Statements   : 100% ( 1206/1206 )
Branches     : 100% ( 497/497 )
Functions    : 100% ( 201/201 )
Lines        : 100% ( 1198/1198 )
================================================================================
